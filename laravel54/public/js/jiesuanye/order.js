    ...
    success: function(consigneeResult, textStatus) {
      ...
      if (consigneeResult.success) {
        ...
        if (consigneeResult.defaultElectro) {
          $("#part-inv").html("<span class='mr10'>普通发票（电子）<i class='invoice-tips-icon' data-tips='电子发票与纸质发票具有同等法律效力，可支持报销入账、商品售后凭证。'></i>&nbsp; </span><span class='mr10'> 个人&nbsp; </span><span class='mr10'>明细&nbsp; </span><a onclick='edit_Invoice()' class='ftx-05 invoice-edit' href='#none'>修改</a>");
        }
        //港澳售项目
        ...
        if(consigneeResult.resetCommon){
        	if(consigneeResult.selectNormalInvoiceContent=="不开发票"){
        		...
        		//电子发票 
        		$("#part-inv").html("<span class='mr10'>普通发票（电子）<i class='invoice-tips-icon' data-tips='电子发票与纸质发票具有同等法律效力，可支持报销入账、商品售后凭证。'></i>&nbsp; </span><span class='mr10'> "+consigneeResult.selectInvoiceTitle+"&nbsp; </span><span class='mr10'>"+consigneeResult.selectNormalInvoiceContent+"&nbsp; </span><a onclick='edit_Invoice()' class='ftx-05 invoice-edit' href='#none'>修改</a>");
        	}
        }
