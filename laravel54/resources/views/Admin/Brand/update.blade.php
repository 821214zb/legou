    ...
    <div class="body-content">
        <form method="post" class="form-x">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="brand_name" value="{{$row->brand_name}}" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="brand_sort" value="{{$row->brand_sort}}"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <textarea  class="input" name="brand_text" rows="4" cols="20">{{$row->brand_text}}</textarea>
                </div>
            </div>
            <div class="form-group">
