    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/node/add">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <SELECT class="medium bLeft" name="level" onchange="getList(this)">
                        <option value="1" class="aa">应用</option>
                        <option value="2" class="aa">模块</option>
                        <option value="3" class="aa">方法</option>
                    </SELECT>
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <SELECT class="medium bLeft" name="pid" id="pid">
